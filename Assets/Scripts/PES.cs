...
public class PES : MonoBehaviour
{
    ...
    private string backgroundOrder = "Also, you will answer the coordinates of each element and provide the output in the requested format using directions: 'Up', 'Down', 'Left', and 'Right' with natural number.\n\n"
                                    + "You have to send me the coordinates of the start point, the goal point and the obstacles and the output in the requested format. You must not answer anything except for what I ordered.";
